...
/*=============================================
	=          achievement Slider              =
=============================================*/
var achievement = new Swiper('.achievement', {
    slidesPerView: 3,
    spaceBetween: 12,
    loop: true,
    autoplay: {
...
/*=============================================
	=          achievement Slider              =
=============================================*/
var achievement = new Swiper('.policy-section', {
    slidesPerView: 5,
    spaceBetween: 12,
    loop: true,
    autoplay: {
...
var projectSlider = new Swiper('.ease_of_leaving_silder', {
    slidesPerView: 3,
    spaceBetween: 24,
    // autoplay:false,
    loop: true,
...
var projectSlider = new Swiper('.welcome_growth_silder', {
    slidesPerView: 2,
    spaceBetween: 24,
    autoplay: {
        delay: 2000,
...
var projectSlider = new Swiper('.land_bank_slider', {
    slidesPerView: 2,
    spaceBetween: 24,
    autoplay:false,
    clickable: true,
